...
public class AIData  {
    ...
    [Tooltip("Self GameObject to be assigned.")]
    ...
    [HideInInspector]
    public AIData m_ChaseTarget;
    [HideInInspector]
    public Vector3 m_vTargetVector;
    [HideInInspector]
    public Vector3 m_vCurrentVector;
    [HideInInspector]
    public Vector3 m_vNewVector;
    [HideInInspector]
    ...
    public bool m_bMove;
    [HideInInspector]
    public float m_fMoveAmount;
    [HideInInspector]
    public float m_fTimeCounter;
